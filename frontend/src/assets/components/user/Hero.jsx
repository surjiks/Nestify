...
const Hero = () => {
  return (
    <div className="bg-gradient-to-t from-[#8ED87B] to-[#DBEED6] h-[400px] p-5 relative">
      ...
      <img className="absolute right-0 md:-top-22 md:h-170 z-1 h-50 top-40" src={homeimg} alt=""/>
      ...
      <div className="filter h-32 w-250 p-2 bg-[#FFFFFFA6] absolute top-85 left-90">
        ...
        <input type="text" placeholder="Location"/><i className="fa-solid fa-location-dot -ml-5"></i>
        <input type="text" placeholder="Property Type"/><i className="fa-solid fa-house -ml-6"></i>
        <input type="text" placeholder="Budget"/><i className="fa-solid fa-indian-rupee-sign -ml-5"></i>
        <button className="bg-[#435D35] h-[40px] w-35 text-xl text-white rounded-lg ml-8">Search Now</button>
      </div>
    </div>
  )
}
